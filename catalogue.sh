...
cp F:\Devaws\git\roboshop-shell\catalogue.service catalogue.service /etc/systemd/system/catalogue.service
...
cp F:\Devaws\git\roboshop-shell\mongo.repo /etc/yum.repos.d/mongo.repo
